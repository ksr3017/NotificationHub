...
import { NotificationTopicConfigurationIndex } from "./notificationTopicConfiguration/NotificationTopicConfigurationIndex";
...
const AppLayout = (): React.ReactElement => {
  const history = useHistory();
  useBreadcrumbs("/", "EvryNotificationHub");
  ...
  return (
    <>
      <Menu
        ...
        logoContent={
          <Link to="/">
            <CircleBadge name={"EvryNotificationHub"} />
          </Link>
        }
      ></Menu>
      <MainLayout.Content>
        ...
        <Page>
          <Switch>
            ...
            <PrivateRoute
              ...
              component={NotificationTopicConfigurationIndex}
            />
          </Switch>
        </Page>
      </MainLayout.Content>
